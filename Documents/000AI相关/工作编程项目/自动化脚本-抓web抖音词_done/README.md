...
### v1.1.0 (2025-01-24) - 项目清理和优化版本 ✨ 最新稳定版
- 🧹 **项目清理**：移除冗余和临时文件，优化项目结构
- 🗑️ **文件整理**：删除移山科技官网相关文件
- 🗑️ **数据清理**：删除对外数据分析相关文件
- 🗑️ **脚本优化**：删除自动化脚本相关文件
- 📁 **结构优化**：保留核心功能文件，完善项目配置
- 📚 **文档更新**：更新README文档和项目说明
- ⚙️ **配置完善**：完善项目配置和依赖管理
- 🏷️ **版本管理**：创建标准版本标签v1.1.0

### v2.0.0 (2025-10-19) - 连接版本
...
#### 完成的主要任务
1. **项目清理**：移除了大量冗余和临时文件
2. **文件整理**：删除了移山科技官网相关文件
3. **数据清理**：删除了对外数据分析相关文件
4. **脚本优化**：删除了自动化脚本相关文件
5. **版本管理**：创建了标准版本标签v1.1.0
6. **文档更新**：更新了README文档记录版本历史

#### 关键决策和解决方式
- 采用语义化版本号v1.1.0，表示功能更新
- 保留核心抖音抓取功能文件
- 删除所有非核心相关项目文件
- 使用详细的提交信息记录变更内容
- 创建带注释的git标签便于版本管理
